            ...
            <form method="POST" action="{{ route('register.post') }}">
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input id="phone_number" name="phone_number" type="tel" placeholder="1234 567 890" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input id="post_code" name="post_code" type="text" placeholder="1234" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="state">State</label>
                            <input id="state" name="state" type="text" placeholder="State/Province" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input id="card_holder" name="card_holder" type="text" placeholder="Name on card" required>
                    </div>
                    <div class="form-group">
                        <label for="card_number">Card Number</label>
                        <input id="card_number" name="card_number" type="text" placeholder="1234 5678 9012 3456" required>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="card_expire">Expiry Date</label>
                            <input id="card_expire" name="card_expire" type="month" required>
                        </div>
                        <div class="form-group">
                            <label for="card_cvv">CVV</label>
                            <input id="card_cvv" name="card_cvv" type="number" placeholder="123" required>
                        </div>
                    </div>
                </div>
